...
unsigned char bin_string_engine::str01_to_char(const std::string::const_iterator & strbegin, const std::string::const_iterator & strend)
{
...
std::string bin_string_engine::compress(const std::string str)
{
    std::string outstr("");
	size_t i;
...
std::string bin_string_engine::char_to_str01(const unsigned char ch, size_t n)
{
    assert(n<=8);
    std::string str("");
    uint8_t j = 0x80;
...
std::string bin_string_engine::decompress(const std::string str, size_t n)
{
    std::string outstr("");
    size_t i;
